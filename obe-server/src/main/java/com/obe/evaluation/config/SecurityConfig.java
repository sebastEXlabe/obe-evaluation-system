    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.cors(c -> c.configurationSource(corsConfigurationSource()))
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // Project: milestones/tasks/repos → ADMIN/TEACHER; journals/git-commits/contributions → authenticated (students can write)
                .requestMatchers(HttpMethod.POST, "/api/project/milestones", "/api/project/tasks").hasAnyRole("ADMIN", "TEACHER")
